...
Revision ID: f90885b8f385
Revises: 
Create Date: 2025-12-22 00:30:42.539095
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_removed_students_id'), 'removed_students', ['id'], unique=False)
